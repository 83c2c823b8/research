...
したがって，$Z$は固有値$e^{\frac{2\sqrt{-1}\pi}{h}}$の固有空間の元であるので，相異なるものは$\CC$倍の違いのみである．\\
最後に，スライス$\P$の一意性を示す．Dynkin箙の表現の圏ではJordan-H\"olderフィルとレーション，その導来圏はHarder-Narasimhan分解を持つため
\end{proof}
