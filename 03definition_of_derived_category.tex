...
\begin{prop}\label{prop:cohomological functor and triangulated category}
...
\begin{prop}\label{prop:triangulated category and multiplicative system}
...
\begin{proof}
	...
	(MS2) 
	$t\circ s$が定義できる任意の$s,t\in S$に対して，八面体公理より
			\[
