...
\maketitle
\tableofcontents
\input{01triangulated_category}
\input{02fundamental_property_of_triangulated_category}
\input{03definition_of_derived_category}
\input{04properties_tri}
\input{05t_structure}
\input{06stability_conditions}
\input{07space_of_stability_conditions}
\input{08qgr}
\input{09GL}
\input{10matrix_factorization}
\input{11AR.tex}
\input{12hariawase}
...
Emanuele Macri, Sukhendu Mehrotra, Paolo Stellari
	...
	\bibitem[Hum90]{Hum90}
	Humphreys, J. 
	\textit{Reflection groups and Coxeter groups, Cambridge Studies in Advanced Mathematics}
...
London Mathematical Society Lecture Note Series \textbf{119},
